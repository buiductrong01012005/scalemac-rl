...
_METRIC_KEYS = (
    ...
    "p95_csi_abs_error",
    "csi_stale_fraction",
    "csi_report_age_slots",
    "csi_report_generated",
    "csi_report_delivered",
    "mean_mcs_index",
    "mean_modulation_order",
    "mean_predicted_bler",
    "observed_bler",
    "spectral_efficiency_bps_hz",
    "attempted_spectral_efficiency_bps_hz",
    "harq_retransmission_attempts",
    "harq_retransmission_fraction",
    "throughput_score",
    "fairness_score",
...
def summarize_episode(
    *,
    ...
    row: dict[str, Any] = {
        ...
        "mean_reported_cqi": mean(metrics["mean_reported_cqi"]),
        "mean_csi_abs_error": mean(metrics["mean_csi_abs_error"]),
        "max_p95_csi_abs_error": max(metrics["p95_csi_abs_error"]),
        "mean_csi_stale_fraction": mean(metrics["csi_stale_fraction"]),
        "mean_csi_report_age_slots": mean(metrics["csi_report_age_slots"]),
        "mean_csi_report_generated_rate": mean(metrics["csi_report_generated"]),
        "mean_csi_report_delivered_rate": mean(metrics["csi_report_delivered"]),
        "mean_mcs_index": mean(metrics["mean_mcs_index"]),
        "mean_modulation_order": mean(metrics["mean_modulation_order"]),
        "mean_predicted_bler": mean(metrics["mean_predicted_bler"]),
        "mean_observed_bler": mean(metrics["observed_bler"]),
        "mean_spectral_efficiency_bps_hz": mean(metrics["spectral_efficiency_bps_hz"]),
        "mean_attempted_spectral_efficiency_bps_hz": mean(
            metrics["attempted_spectral_efficiency_bps_hz"]
        ),
        "mean_harq_retransmission_attempts": mean(
            metrics["harq_retransmission_attempts"]
        ),
        "mean_harq_retransmission_fraction": mean(
            metrics["harq_retransmission_fraction"]
        ),
